  <!-- footer content -->
    ...
    <!-- gauge.js -->
    <script src="{{asset('gentellela/vendors/gauge.js/dist/gauge.min.js')}}"></script>
    ...
    <!-- Skycons -->
    <script src="{{asset('gentellela/vendors/skycons/skycons.js')}}"></script>
    <!-- Flot -->
    ...
    <!-- JQVMap -->
    <script src="{{asset('gentellela/vendors/jqvmap/dist/jquery.vmap.js')}}"></script>
    <script src="{{asset('gentellela/vendors/jqvmap/dist/maps/jquery.vmap.world.js')}}"></script>
    <script src="{{asset('gentellela/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js')}}"></script>
