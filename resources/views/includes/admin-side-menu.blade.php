              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                 ...
                 <li><a><i class="fa fa-edit"></i> Users Management <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-edit"></i> Agent Management<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
...
<li><a><i class="fa fa-edit"></i> Advert Management<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">Balance</a></li>
                    ...
                    <li><a><i class="fa fa-edit"></i>Payment and Rewards <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
